...
//		//1) Get the container where the agent will appear
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, Agent.class.getName(), entityParametersExplo1);//
		agentList.add(ag);
		CommunicationList.getInstance().addIdToIdList(agentName);
		/*********
		 * AGENT Explo2
		 *********/
		//1) Get the container where the agent will appear
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, Agent.class.getName(), entityParametersExplo2);//ExploreSoloAgent		
		agentList.add(ag);
		CommunicationList.getInstance().addIdToIdList(agentName);
//		
		...
		//4) Give the class name of your agent to let the system instantiate it
		ag=createNewDedaleAgent(c, agentName, Agent.class.getName(), entityParametersExplo3);//ExploreSoloAgent		
		agentList.add(ag);
		CommunicationList.getInstance().addIdToIdList(agentName);
